  ...
  <x-layout.inner>
    <div class="text-sm text-center flex flex-col gap-y-10 lg:flex-row lg:items-center lg:justify-center lg:gap-x-5">
      ...
      <div class="flex items-center justify-center gap-x-10 xl:gap-x-15">
        ...
        <a
          href="https://www.instagram.com/sprossgarten/"
          target="_blank"
          rel="noopener noreferrer"
          title="Spross auf Instagram"
          class="inline-block group">
          <x-icons.instagram class="{{ Route::is('page.competition') || Route::is('page.dashboard') ? 'text-fern' : 'text-white' }}" />
        </a>
